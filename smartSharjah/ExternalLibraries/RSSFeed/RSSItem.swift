...
//    }
    ...
    open var description: String {
//        return "\t: \(String(describing: self.title))\n\t: \(String(describing: self.itemDescription))\n\tpubDate: \(String(describing: self.itemDescription))\n\t"
        
//       self.itemDescription = self.itemDescription?.replacingOccurrences(of: "Optional", with: "")
//        self.itemDescription = self.itemDescription?.replacingOccurrences(of: ")", with: "")
//        self.itemDescription = self.itemDescription?.replacingOccurrences(of: "(", with: "")
////        self.itemDescription = self.itemDescription?.replacingOccurrences(of: "Optional", with: "")
//        self.itemDescription = self.itemDescription?.replacingOccurrences(of: "Sharjah 24&#58;", with: "")
//        return " \(String(describing: self.itemDescription))\n\t"
